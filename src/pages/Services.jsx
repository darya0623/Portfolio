    ...
    <div>
      <section className={ServiceStyle["services"]}>
        ...
        <p className={ServiceStyle["services-text"]}>
          Верстаю сайты переводя макеты из Figma в чистый, валидный и семантический HTML код. Это значит что он будет работать без ошибок, хорошо индексироваться поисковыми роботами и поможет вашему сайту занять хорошие позиции в поиске.
        </p>
        ...
        <ul className={ServiceStyle["services-list"]}>
          <li>
            HTML5, CSS3, Flexbox, SCSS, JS, jQuery, Gulp, Webpack
          </li>
